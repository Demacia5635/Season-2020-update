...
public class FeedForward {
    ...
    public static double K_HA = 2.5;
    public static double K_LA = 0.51;
    public static double K_S = Constants.CHASSIS_KS; //0.22404
    public static double K_V = Constants.CHASSIS_KV; //0.04314
    ...
    public static double feedForwardPower(double velocity) {
        return velocity * K_S + K_V * Math.signum(velocity);
    }

 ...
 * Add your docs here.
 */
public abstract class CommandGroupBaseDemacia extends CommandBase implements Command {
    ...
    /**
     * Clears the list of grouped commands, allowing all commands to be freely used
     * again.
     *
     * <p>
     ...
     * CommandGroup. Throws an {@link IllegalArgumentException} if commands have
     * been allocated.
     *

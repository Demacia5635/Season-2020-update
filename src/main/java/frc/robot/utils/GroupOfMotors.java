...
public class GroupOfMotors {
    ...
    public GroupOfMotors(int... ports) {
        this(Arrays.stream(ports).mapToObj(port -> new WPI_TalonSRX(port))
                .toArray(WPI_TalonSRX[]::new));
    }
    ...
    public double getError() {
        return 0.0;//this.lead.getClosedLoopError(); 
    }
    ...
    public void invertMotors() {
        ...
        for (WPI_TalonSRX talon : followers) {
    ...
    public double getEncoder() { // Pulses
        return 0.0;//this.lead.getSelectedSensorPosition();
    }
    ...
    public double getDistance() { // Meters
        return 0.0;//this.getEncoder() / Constants.PULSES_PER_METER;
    }
